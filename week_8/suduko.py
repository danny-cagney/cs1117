def readBoard (file):
    #read in file, data in the right format, and in this a 2d list
    b = []
...
#Second Hint: Within every row you would like to print every column in that row. The character '|' needs to go at the start, end and after every third column. If there's a zero a space should be printed.
    ...
    #specify your print statement with space 
...
# #At the end of my loop, set the square back to zero, pass back false and the board return result, b
...
#     # To do this you need to get the starting square e.g. 4 // 3 * 3 = 3 (row) and 1 // 3 * 3 = 0 (column)
